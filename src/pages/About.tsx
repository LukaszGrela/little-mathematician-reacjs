  ...
  return (
    <div className="about">
      ...
      <div className="content">
        Simple Maths game for children made in ReactJS with aim to explore this
        framework.
      </div>
      <div className="git-source">
        <GitHubIcon />
        <a
          href="https://github.com/LukaszGrela/little-mathematician-reacjs"
          target="_blank"
          rel="noopener noreferrer"
        >
          LukaszGrela/little-mathematician-reacjs
        </a>
      </div>

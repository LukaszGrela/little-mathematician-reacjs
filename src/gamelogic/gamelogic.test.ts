...
import {
  prepareQuestionsAddition,
  prepareQuestionsSubtraction,
  prepareQuestionsMultiplication,
  prepareQuestionsDivision,
  prepareQuestions,
  mergeSettings,
  generateGameObject,
} from "./gamelogic";
...
test("Should mergeSettings return correct values", () => {
  const config: Omit<TGameConfig, "type"> = {
    general: {
      questionCount: 10,
      from: 0,
      to: 10,
